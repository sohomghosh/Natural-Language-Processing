...
filename="new_mixed_review_tokenized_with_stopwords-removed_and_stemming_done.txt"
filename2="mispelt_removed_mixed_review_tokenized_with_stopwords-removed_and_stemming_done.txt";
f=open(filename,"r");
f2=open(filename2,"w");
